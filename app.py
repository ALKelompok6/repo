...
st.line_chart(data=realisasi_peserta_by_nama, x=['NAMA'], y=['RENCANA PESERTA', 'TOTAL REALISASI PESERTA'], color_discrete_sequence = ['#F63366'], width=0, height=0, use_container_width=True)
